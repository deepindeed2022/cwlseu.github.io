...
![@HOG特征提取算法的实现过程](https://cwlseu.github.io/images/fhog/process.jpg)
...
![@](https://cwlseu.github.io/images/fhog/cell.jpg)
...
![@每个cell中的像素梯度最后离散化为9个bin中，其中的bins统计各个bin中hist信息](https://cwlseu.github.io/images/fhog/bin.png)
...
![@cell与block之间的关系](https://cwlseu.github.io/images/fhog/cell2block.png)，一个block内所有cell的特征descriptor串联起来便得到该block的HOG特征descriptor。这个在OpenCV中有HogCache中getBlock进行实现的。
...
![@HOG算法名词之间的关系结构图](https://cwlseu.github.io/images/fhog/cell-block-window-image.png)
...
部分进行了删减，只剩下算法的精要部分。
![@OpenCV中关于HogDescriptor的实现](https://cwlseu.github.io/images/fhog/opencv-hog.png)
...
```
![@我的手工笔记](https://cwlseu.github.io/images/fhog/notes.jpg)
[源码下载](https://cwlseu.github.io/images/fhog/hog.cpp)
