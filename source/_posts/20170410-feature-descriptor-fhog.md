...
![@HOG特征提取算法的实现过程](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/process.jpg)
...
![@](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/cell.jpg)
...
![@每个cell中的像素梯度最后离散化为9个bin中，其中的bins统计各个bin中hist信息](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/bin.png)
...
![@cell与block之间的关系](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/cell2block.png)，一个block内所有cell的特征descriptor串联起来便得到该block的HOG特征descriptor。这个在OpenCV中有HogCache中getBlock进行实现的。
...
![@HOG算法名词之间的关系结构图](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/cell-block-window-image.png)
...
部分进行了删减，只剩下算法的精要部分。
![@OpenCV中关于HogDescriptor的实现](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/opencv-hog.png)
...
```
![@我的手工笔记](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/notes.jpg)
...
![@31个向量](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030318107.jpg)
