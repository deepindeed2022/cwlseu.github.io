...
![@图 1 LSB图标](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030306242.png)
...
![图 2 LSB 3.1规范包含的组件](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030306678.jpg)
...
![图 3 LSB 主要版本的路线图](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030306889.jpg)
...
![@LSB初始界面](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307939.png)

![@LSB报告界面](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307159.png)

![@LSB调用接口分析界面](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307390.png)
在ubuntu16.04上安装正常，使用正常。

### CDOS上安装失败，出现500 Internal Server Error

1. 安装lsb和lsb-core
![@安装lsb过程中出现包依赖错误](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307364.png)
2. lsb-app-checker访问错误1
![@访问错误](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307354.png)
后面经过几番折腾，已经fix掉。开始使用进行application LSB标准检测吧。结果出现如下问题：
![@数据分析错误](https://cdn.jsdelivr.net/gh/cwlseu/deepindeed_repo@main/img/202209030307079.png)
