...
![@贝叶斯目标函数](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-1.jpg)
...
![@贝叶斯目标函数](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN.jpg)


## 目标函数计算

![@条件概率计算](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-2.jpg)
我们可以看出，较小的Hamming距离对应较大的内积<hi, hj>，那么p(1|hi,hj) 的值将比较大，也就
是说明hi 和hj是相似的；反之，p(0|hi,hj)的值将比较大，hi 和hj是不相似的.
![@条件概率计算](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-3.jpg)
通过上面两个式子，我们可以将贝叶斯目标函数转化为如下目标函数
![@目标函数转换](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-4.jpg)

但是又有一个问题:Q函数是离散的，不好求导，不容易进行BP学习。那么我们就采用
![@目标函数中Q的转换](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-7.jpg)进行代替。

最后，总结一下现在的目标函数：
![@文章中采用的模板函数](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-8.jpg)
...
![@实验结果](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-Table1.jpg)
...
![@NUS-WIDE dataset实验结果](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-Fig3.jpg)
![@CIFAR-10实验结果](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-fig4.jpg)
...
![@目标函数的不同组合的结果实验结果](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-Table2.jpg)
We investigate several variants of DHN: DHN-B is the DHN
variant without binarization (h ← sgn(zl) not performed), which may serve as an upper bound of performance. DHNQ is the DHN variant without the quantization loss (λ = 0). DHN-E is the DHN variant using widely-adopted pairwise quared loss![@之前的损失函数](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/deephash/DHN-12.jpg) instead of the pairwise cross-entropy loss.
