...
\end{document}
```
![@table](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/latex/table2.png)
...
```latex
 ...
 ```
公式显示结果
![@公式显示结果](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/latex/math.png)
...
\end{align}
```
显示出来是这样子的![@](https://github.com/cwlseu/cwlseu.github.io/tree/master/images/latex/align.png)
