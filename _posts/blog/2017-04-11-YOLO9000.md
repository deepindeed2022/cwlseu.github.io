...
![@](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/模型设计考虑因素.png)
...
<!-- <figure class="half">
    <img src="https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/ClusterBox.png"  width = "280">
    <img src="https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/AvgIOU.png"  width = "280">
</figure> -->
![@簇集的Box位置信息](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/ClusterBox.png)
![@不同方法进行簇集的AVGIOU结果](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/AvgIOU.png)
...
![@Prediction Location and BoundingBox之间的位置关系](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/bbox-loc-prediction.png)
...
![@速度和准确率的权衡Table 3：在voc2007上的速度与精度](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/Precision-Speed.jpg) 
这一策略让网络在不同的输入尺寸上都能达到一个很好的预测效果，同一网络能在不同分辨率上进行检测。当输入图片尺寸比较小的时候跑的比较快，输入图片尺寸比较大的时候精度高，所以你可以在YOLO v2的速度和精度上进行权衡。 

![@性能的对比](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/Performance.PNG)
<!-- <figure class="half">
    <img src="https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/Precision-Speed.png"  width = "285">
    <img src="https://github.com/cwlseu/cwlseu.github.io/blob/master/images/yolo/Performance.png"  width = "285">
</figure>
 -->
