...
* 
![国产申威 26010 处理器架构图](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/cuda/cell_arch.png)

### 多点计算
集群，当前最流行的莫过于Hadoop和spark了，一个是分布式文件系统，一个是分布式计算框架，这两个工具使得多点计算的方法充分发挥。

### GPU架构
![](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/cuda/2.png)

![](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/cuda/1.png)
