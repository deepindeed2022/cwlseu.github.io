...
![@图 1 LSB图标](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/1.png)
...
![图 2 LSB 3.1规范包含的组件](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/2.jpg)
...
![图 3 LSB 主要版本的路线图](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/3.jpg)
...
![@LSB初始界面](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/lsb-1.png)

![@LSB报告界面](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/lsb-2.png)

![@LSB调用接口分析界面](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/lsb-3.png)
在ubuntu16.04上安装正常，使用正常。

### CDOS上安装失败，出现500 Internal Server Error

1. 安装lsb和lsb-core
![@安装lsb过程中出现包依赖错误](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/install_lsb.png)
2. lsb-app-checker访问错误1
![@访问错误](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/Templates.png)
后面经过几番折腾，已经fix掉。开始使用进行application LSB标准检测吧。结果出现如下问题：
![@数据分析错误](https://github.com/cwlseu/cwlseu.github.io/blob/master/images/LSB/Distros.png)
